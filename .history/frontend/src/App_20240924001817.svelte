<script>
	...
	async function editTodo(id) {
		...
		// Update the placeholder text and pre-filled form content
		document.getElementById("todo-title").placeholder = todo.title;
		document.getElementById("todo-description").placeholder = todo.description;
		document.getElementById("todo-dueDate").placeholder = todo.dueDate;
	}

            ...
            <div id="fixItApp">
				<div id="popupCont">
					...
					<form>
						...
						<input type="text" id="todo-description" placeholder="Todo description" />
						<input type="text" id="todo-dueDate" placeholder="Todo dueDate" />
						<button on:click={createTodo()}id="create-todo-btn">Create</button>
					</form>
				</div>
                <div id="todoList">

<script>
	...
	async function editTodo(id) {
		...
		document.getElementById(`dueDate-${id}`).value = todo.dueDate;
		document.getElementById(`title-${id}`).placeholder = todo.title;
		document.getElementById(`description-${id}`).placeholder = todo.description;
		document.getElementById(`dueDate-${id}`).placeholder = todo.dueDate;
		// Set placeholders to these values as well
